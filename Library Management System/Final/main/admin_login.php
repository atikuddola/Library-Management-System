...
if (isset($_POST['submit'])) {
    ...
    if ($row && password_verify($password, $row['password'])) {
        ...
        header("Location: index_loginadmin.php");
        exit();
    } else {
  ...
  <section>
    <div class="log_img">
      ...
      <div class="box1">
        ...
        <h1 class="login-title" style="font-size: 40px;">Your Admin Credentials</h1>
        <br>
        <form name="login" action="" method="post">
          ...
          <p class="login-links">
            <span class="new-user">Newly Appointed Admin? <a href="admin_registration.php" class="get-started-button">Sign Up</a></span>
        </form>
      </div>
    </div>  
  </section>
